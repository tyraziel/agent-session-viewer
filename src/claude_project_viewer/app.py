...
def create_app(config: Config | None = None):
    ...
    @ui.page("/{provider}/project/{project_name}")
    def project_sessions(provider: str, project_name: str):
        _page_setup()
        create_session_list_page(project_name, provider)
    ...
    def session_detail(provider: str, project_name: str, session_id: str):
        _page_setup()
        create_session_detail_page(project_name, session_id, provider)
